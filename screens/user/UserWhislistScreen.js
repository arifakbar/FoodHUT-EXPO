...
import { getUserWishlist, removeFromUserWishlist } from "../../functions/wishlist";
        ...
        <View style={styles.conatiner}>
            {loading ? <Loading /> :
                wishlist.length < 1 ?
                    ...
                    <FlatList data={wishlist.wishlist} keyExtractor={p => p._id} contentContainerStyle={{ width: "85%" }} renderItem={p => {
                        return <TouchableOpacity style={styles.container} onPress={() => props.navigation.navigate("Products", {
                            screen: "Product",
                            params: {
                                id: p.item._id,
                                title: p.item.title
                            ...
                            <TouchableOpacity style={styles.btn} onPress={() => remove(p.item._id)}>
