...
function ContactScreen(props) {
    ...
    const addContact = async () => {
        ...
        try {
            setLoading(true);
            const res = await createContact(user.token, name, email, subject, message);
    ...
    return (
        <ImageBackground source={require("../assets/images/contact.jpg")} style={styles.img} imageStyle={{}}>
            {loading ? <Loading /> :
                <ScrollView style={styles.conatiner}>
                    <View style={styles.info}>
                        ...
                        <View style={styles.content}>
                            ...
                            <Text style={styles.time}>
                                9:00 AM to 9:00 PM in Weekdays
                            </Text>
                            <Text style={styles.time}>
                                1:00 PM to 8:00 PM in Weekends
                            </Text>
                        </View>
                        <View style={styles.content}>
                    ...
                    <View style={styles.form}>
                        <TextInput placeholder="Full Name" style={styles.input} value={name} onChangeText={e => setName(e)} />
                        <TextInput placeholder="Email Address" style={styles.input} value={email} onChangeText={e => setEmail(e)} />
                        <TextInput placeholder="Subject" style={styles.input} value={subject} onChangeText={e => setSubject(e)} />
                        <TextInput placeholder="Message" style={styles.input2} value={message} onChangeText={e => setMessage(e)} />
