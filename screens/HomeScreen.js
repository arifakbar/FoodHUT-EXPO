            ...
            {loading ?
                ...
                <View style={styles.container}>
                    {props.route.params.type == "login" ?
                        ...
                        <SignupModal visible={props.route.params.modal} navigation={props.navigation} />
                    }
                    {/* <SignupCompleteModal visible={props.route.params.modal} navigation={props.navigation} /> */}
                    <View style={styles.inputContainer}>
                        <TextInput placeholder="Search here...." style={styles.search} value={query} onChangeText={e => setQuery(e)} />
                        <TouchableOpacity style={styles.searchBar} disabled={query.length < 3} onPress={() => props.navigation.navigate("Search", { query })} >
                            <Ionicons name="search" size={20} color="grey" />
                        </TouchableOpacity>
                    </View>
                    <Banner title="Snacks" img={[require('../assets/images/menu-ff-pizza.jpg'), require('../assets/images/menu-ff-frankie.jpg'), require('../assets/images/menu-ff-pasta.jpg')]} id="615495913223dc77b6b85905" navigation={props.navigation} />
                    <MoreIn data={snacks} navigation={props.navigation} />
                    <View style={styles.banner2}>
                        <TouchableOpacity>
                            <Text style={styles.bannerText2}>Full Course</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.bannerScroll} onPress={() => props.navigation.navigate("Products", {
                            screen: "Products2",
                            params: { id: "615496563223dc77b6b85911", title: "Full Course", search: "category" }
                        })}>
                    ...
                    <Banner title="Drinks" img={[require('../assets/images/menu-drinks-mocktail.jpg'), require('../assets/images/menu-drinks-shakes.jpg'), require('../assets/images/menu-drinks-soup.jpg')]} id="615495973223dc77b6b85909" navigation={props.navigation} />
                    <MoreIn data={drinks} navigation={props.navigation} />
                    <Banner title="Desserts" img={[require('../assets/images/menu-desserts-ball.jpg'), require('../assets/images/menu-desserts-cake.jpg'), require('../assets/images/menu-desserts-icecream.jpg'), require('../assets/images/menu-desserts-sandwich.jpg')]} id="6154966a3223dc77b6b85915" navigation={props.navigation} />
    ...
    return {
        ...
        headerRight: () => {
            return user && user.token ?
                ...
                <TouchableOpacity style={styles.loginBtn} onPress={() => { props.navigation.setParams({ modal: true, type: "login" }) }}>
