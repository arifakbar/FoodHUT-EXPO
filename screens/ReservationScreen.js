...
function ReservationScreen(props) {
    ...
    return (
        <View style={styles.container}>
            <ImageBackground source={require("../assets/images/Easy-Inside-Bottles.jpg")} style={styles.img}>
                    ...
                    <>
                        ...
                        <View style={styles.form}>
                            <View style={styles.formInput}>
                                ...
                                <TextInput style={styles.input} value={name} onChangeText={e => setName(e)} placeholder="Enter name for reservation." />
                            </View>
                            <View style={styles.formInput}>
                                <Text style={styles.labelText}>Date: </Text>
                                <View style={styles.dateInput}>
                                    <TouchableOpacity onPress={showDatepicker}>
                                        <Ionicons name="calendar-outline" size={32} color="#DA9816" />
                                    </TouchableOpacity>
                            ...
                            <View style={styles.formInput}>
                                ...
                                <TextInput keyboardType='numeric' style={styles.input} value={guests} onChangeText={e => setGuests(e)} placeholder="Enter total number of guests." />
                            </View>
